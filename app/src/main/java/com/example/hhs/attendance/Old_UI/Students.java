...
//                // show it
    ...
    private class MyTask extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... params) {
            String BASE_URL1 = BASE_URL+CID+"/classes/"+uname+"/"+Classes.cur_class+"/";
    ...
    private class MyTask1 extends AsyncTask<String, Integer, String>
    {
        ...
        protected String doInBackground(String... params) {
            ...
            String URL = BASE_URL+CID+"/classes/"+uname+"/"+Classes.cur_class+"/";
            ...
            fb_db2.addValueEventListener(new ValueEventListener()
            {
                ...
                public void onDataChange(DataSnapshot dataSnapshot)
                {
                    ...
                    for(DataSnapshot postSnapshot:dataSnapshot.getChildren())
                    {
                        ...
                        System.out.println("j is "+postSnapshot.getKey());
